...
import com.study.webfluxsecurity.exception.AuthException;
...
public class SecurityService {
    ...
    private TokenDetails generateToken(Map<String, Object> claims, String subject) {
        Long expirationTineInMillis = expirationInSeconds * 1000L;
        Date expirationDate = new Date(new Date().getTime() + expirationTineInMillis);
